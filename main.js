...
// 🚨 @PATCH : **2026-09-11** — [SQLite getDesktopKnowledgeDb 파일 잠금 누수 및 WAL 전환 락 경합 원천 방어] getDesktopKnowledgeDb에서 이미 wal 저널 모드인 경우 PRAGMA journal_mode=WAL 재실행을 건너뛰어 배타적 락 충돌을 방지하고, 오픈/초기화 실패 시 db.close()를 반드시 수행하여 좀비 파일 락 누수를 완벽 차단; init 핸들러에서 초기화 전 자동 스냅샷 백업 및 최신 백업 목록 반환 연동
