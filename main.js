...
// 🚨 @PATCH : **2026-09-11** — [지식 베이스 복원 시 안전 스냅샷 WAL 체크포인트 및 캐시 해제 순서 정상화] restore 핸들러에서 스냅샷 생성 전 기존 활성 DB의 wal_checkpoint(TRUNCATE) 및 DB close를 선행하여 WAL 누락 및 파일 잠금(database is locked) 충돌 방어
