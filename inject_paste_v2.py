...
for i, line in enumerate(lines):
    if 'const fixMarkdownTable = (text: string) => {' in line:
        start_idx = i
...
new_logic = """  const sanitizePastedText = (text: string) => {
    let sanitized = text;
    // 1. Clean up broken <br> tags with adjacent newlines
    // <br>\\n<br> or <br>\\r\\n<br> -> <br>
    ...
    // 2. Auto-convert TSV to Markdown Table
