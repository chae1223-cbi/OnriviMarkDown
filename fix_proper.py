...
filePath = 'D:/Developer/OnriviMarkDown/OnriviMarkDown/frontend/src/components/MainEditorApp.tsx'

with open(filePath, 'r', encoding='utf-8') as f:
    lines = f.readlines()

# Replace lines 1213 to 1251 (0-indexed, so 1214 to 1252)
start = 1213
end = 1252

replacement = """            let activationFailed = false;
            let activationError = '';
