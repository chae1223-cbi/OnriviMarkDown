...
const startStr = "if (tag === 'codeBlock') {";
const endStr = "if (borderRadius) {";
...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    const newStr = `if (tag === 'codeBlock') {
          ...
          if (bgColor) {
            ...
            // Apply copy button fallback if codeBlock is styled but codeBlockTitle is not
            if (isDark) {
    ...
    console.log("Success codeBlock");
} else {
    console.log("Failed codeBlock boundaries");
}
