...
const endStr = "editor.setScrollPosition({ scrollTop: interpolatedScrollTop });\n                                  }\n                                }";
...
if (startIdx !== -1) {
    ...
    if (nextIdx !== -1) {
        ...
        console.log("Failed MainEditorApp.tsx to find endStr");
    }
} else {
    console.log("Failed MainEditorApp.tsx to find startStr");
}
