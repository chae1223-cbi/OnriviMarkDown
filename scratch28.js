...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    const after = content.substring(endIdx); // keep "if (tag === 'codeBlock') {"
    
    // We will replace the entire block between startIdx and endIdx
    ...
    console.log("Success codeBlockTitle");
} else {
    console.log("Failed codeBlockTitle boundaries");
}
