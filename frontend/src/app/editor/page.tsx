...
const MainEditorApp = dynamic(() => import('@/components/MainEditorApp'), {
  ssr: false,
  loading: () => (
    <div translate="no" className="flex items-center justify-center h-screen bg-[#0f172a] text-slate-300 font-sans select-none">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="text-sm font-medium tracking-wide"><span>Onrivi Author 로딩 중...</span></div>
      </div>
    </div>
  )
});
