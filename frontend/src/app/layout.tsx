...
// 🛡️ @GUARD : 없음
// 🚨 @PATCH : CSP script-src 'self' 차단으로 mermaid.min.js <script defer> 복원 (2026-06-18); Next.js hydration이 <script>를 제거하여 dynamic load 방식으로 전환, plain script defer 제거 (2026-06-18)
// 🔗 @CALLS : ToastProvider
// ====================================================================
