...
// 🛡️ @GUARD : 없음
// 🚨 @PATCH : **2026-09-16** — [CSP connect-src chrome-extension: 및 도메인 허용 확장]: chrome-extension:, https://onrivi.com, https://*.onrivi.com을 connect-src에 추가하여 브라우저 확장 프로그램 충돌 로그 및 외부 연결 차단 콘솔 에러 완전 해결
