...
// 🛡️ @GUARD : 없음
// 🚨 @PATCH : **2026-09-16** — [CSP connect-src webpack: 가상 프로토콜 허용]: Next.js 개발 모드(next dev)에서 브라우저 개발자 도구가 소스맵(webpack://_N_E/...) 요청 시 CSP connect-src 차단 에러 방지를 위해 webpack: 스키마 추가
