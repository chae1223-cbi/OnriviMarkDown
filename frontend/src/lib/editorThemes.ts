...
export const EDITOR_THEMES: ThemeDefinition[] = [
  {
    ...
    base: 'vs',
    rules: [
      { token: '', foreground: '1B1B24' },
      { token: 'keyword', fontStyle: '', foreground: '0F006D' },
      { token: 'keyword.markdown', fontStyle: '', foreground: '0F006D' },
      { token: 'comment', fontStyle: '', foreground: '777586' },
      { token: 'comment.markdown', fontStyle: '', foreground: '777586' },
      { token: 'strong', fontStyle: '', foreground: '0F006D' },
      { token: 'strong.markdown', fontStyle: '', foreground: '0F006D' },
      { token: 'emphasis', fontStyle: '', foreground: '4B41E1' },
      { token: 'emphasis.markdown', fontStyle: '', foreground: '4B41E1' },
      { token: 'string.link', fontStyle: '', foreground: '4B41E1' },
      { token: 'string.link.markdown', fontStyle: '', foreground: '4B41E1' },
      { token: 'string', fontStyle: '', foreground: '4B41E1' },
      { token: 'variable', fontStyle: '', foreground: '777586' },
    ],
    colors: {
      'editor.background': '#faf9f5',
      'editor.foreground': '#1B1B24',
      'editor.lineHighlightBackground': '#eeece680',
      'editorLineNumber.foreground': '#77758680',
      'editorLineNumber.activeForeground': '#0F006D',
      'editorCursor.foreground': '#0F006D',
      'editor.selectionBackground': '#e4e1ed80'
    }
  },
  {
    id: 'solarized-light',
