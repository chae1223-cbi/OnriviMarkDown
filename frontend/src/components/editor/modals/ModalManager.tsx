  ...
  return (
    <>
      ...
      <SettingsModal
        ...
        editorFontWeight={deps.editorFontWeight}
        setEditorFontWeight={deps.setEditorFontWeight}
        editorHighContrast={deps.editorHighContrast}
        setEditorHighContrast={deps.setEditorHighContrast}
