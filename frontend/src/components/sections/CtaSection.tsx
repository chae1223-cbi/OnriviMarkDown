...
export function CtaSection() {
  return (
    <section
      className="py-28 sm:py-36 px-6 relative overflow-hidden bg-[#DCE1FF] dark:bg-[#121314] text-[#1A1A18] dark:text-[#E8ECE9] border-t border-[#C5CEF8] dark:border-white/5"
      style={{
    ...
    >
      ...
      <div className="max-w-[900px] mx-auto text-center relative z-10">
        ...
        >
          {/* Top Tag */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/90 dark:bg-zinc-800 border border-[#C5CEF8] text-[11px] font-extrabold text-[#1A1A18] dark:text-zinc-200 tracking-widest uppercase shadow-2xs">
