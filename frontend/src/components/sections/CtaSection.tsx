...
export function CtaSection() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-[radial-gradient(ellipse_at_center,rgba(29, 78, 216,0.08)_0%,transparent_70%)] pointer-events-none z-0"
      />
