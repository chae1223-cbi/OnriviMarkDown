  ...
  return (
    ...
    >
      ...
      <div className="max-w-[900px] mx-auto text-center relative z-10">
        ...
        >
          {/* Top Tag */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#EFEFFF] dark:bg-zinc-800 border border-[#E2E4F6] text-[11px] font-extrabold text-[#1A1A18] dark:text-zinc-200 tracking-widest uppercase shadow-2xs">
