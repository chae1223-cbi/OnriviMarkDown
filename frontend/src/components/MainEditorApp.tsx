...
// ====================================================================
// 📊 [OMD-AUTH-MainEditorApp-0016] MainEditorApp.tsx ➔ loadAndVerifyLicense
// 🎯 @KICK  : 저장소에서 라이선스 키 로드, Supabase DB로 검증, 로컬 평가 기간으로 폴백
// 🛡️ @GUARD : 암호화 캐시를 통한 오프라인 유예 기간(3일), 최초 실행 14일 보장, SHA-256 익명 키 생성 폴백
// 🚨 @PATCH : DB를 사용할 수 없는 경우 익명 키를 위한 crypto subtle 폴백
...
// 🚨 @PATCH : Electron 환경을 위한 데스크톱 onLicenseActivated 백업
...
// 🛡️ @GUARD : 원자적 setLicenseStatus + 플랫폼 저장소 저장 (electronAPI, chrome.storage, localStorage)
// 🚨 @PATCH : None
// 🔗 @CALLS : setLicenseStatus, api.saveLicenseFull, chrome.storage.local.set, localStorage.setItem
// ====================================================================
...
// 🚨 @PATCH : 테마 변경 후 찌그러짐 방지를 위한 requestAnimationFrame layout()
...
// 🎯 @KICK  : 창 탭 식별을 위해 현재 파일 이름으로 document.title 업데이트
// 🛡️ @GUARD : None
// 🚨 @PATCH : None
// 🔗 @CALLS : None
// ====================================================================
