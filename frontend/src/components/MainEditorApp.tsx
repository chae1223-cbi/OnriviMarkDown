                      ...
                      return (
                        <div className="flex flex-row items-center gap-3 min-w-max">
                          ...
                          <div className="flex flex-row items-center gap-0.5">
                            ...
                            <button onMouseDown={(e) => { e.preventDefault(); dispatchCommand('YOUTUBE'); setFloatingToolbar(prev => ({ ...prev, visible: false })); }} className="w-7 h-7 hover:bg-black/5 dark:hover:bg-white/5 rounded transition-all flex items-center justify-center text-[13px]" title="유튜브 동영상 삽입">🎞️</button>
