...
export function normalizeCssProfile(
  ...
  const mergedPageStyle = {
    ...
    marginTop: cleanPageStyle.marginTop || DEFAULT_PROFILE.pageStyle.marginTop || '22mm',
    marginBottom: cleanPageStyle.marginBottom || DEFAULT_PROFILE.pageStyle.marginBottom || '22mm',
    marginLeft: cleanPageStyle.marginLeft || DEFAULT_PROFILE.pageStyle.marginLeft || '19mm',
    marginRight: cleanPageStyle.marginRight || DEFAULT_PROFILE.pageStyle.marginRight || '20mm',
