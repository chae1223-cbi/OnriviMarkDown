...
const fileMap = {
  'd:/developer/OnriviMarkDown/frontend/src/components/FormulaModal.tsx': [
    [/\?\릭\?\여 \?\택/g, "클릭하여 선택"],
  ...
  'd:/developer/OnriviMarkDown/frontend/src/components/ImageModal.tsx': [
    [/onClose\(\); \/\/ \?\입 \?\?모달 \?\기 추\\?/g, 'onClose(); // 삽입 후 모달 닫기 추가']
  ],
  'd:/developer/OnriviMarkDown/frontend/src/components/MapModal.tsx': [
  ...
  'd:/developer/OnriviMarkDown/frontend/src/components/MergeModal.tsx': [
  ...
  'd:/developer/OnriviMarkDown/frontend/src/components/SettingsModal.tsx': [
    [/\{\/\* 좌측 \?이\?바 \(\?\? \*\/\}/g, '{/* 좌측 사이드바 */}'],
  ...
  'd:/developer/OnriviMarkDown/frontend/src/components/TableModal.tsx': [
    [/그리\?\\\? \?\릭\?\여 \?\기\\?\?\정\?\세\?\?/g, '그리드를 클릭하여 크기를 지정하세요'],
    [/\{selectedPos\.c\} x \{selectedPos\.r\} \?\?\?\입\?\기/g, '{selectedPos.c} x {selectedPos.r} 표 삽입하기']
  ],
  'd:/developer/OnriviMarkDown/frontend/src/components/YoutubeModal.tsx': [
