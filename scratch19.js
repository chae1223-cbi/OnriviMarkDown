...
let endStr = "editor.setScrollPosition({ scrollTop: interpolatedScrollTop });\n                                  }\n                                }";
...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    // If not found, try to replace all whitespace with regex
    ...
    if(m) {
        ...
        const newStr = `... same ...`; // wait, I can just do it in regex directly
        console.log("Found with regex, but didn't replace because code string is long.");
    } else {
